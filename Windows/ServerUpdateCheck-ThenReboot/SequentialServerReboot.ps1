##Sequential Server Reboot Service##

#Import a CSV with the reference servers we will be working with

$ServersList = Get-Content .\servers.txt

$Servers = Get-Content .\server-reboot.txt | Select-Object Computer

#This function is beautiful and was taken from Technet and full credit and use is ofcourse given to the author whom I have included all relevelant info
...
Function Start-Reboots {

# Get list of Servers
$Servers = Select-Object Computer
...
Get-PendingReboot -Computer $ServersList | Export-Csv .\server-reboot.csv 
